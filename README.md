...
The final goal of all these tasks is to build a converter from a Penpot page to HTML with Tailwind. It should also be possible to convert a Shape and all its children to HTML with Tailwind.

The Penpot typings are in penpot.types.ts; create any additional typings in another file.
