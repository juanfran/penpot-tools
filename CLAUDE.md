...
- `packages/converter` — `@penpot-tools/converter`: library + CLI. Architecture details live in [`packages/converter/CLAUDE.md`](packages/converter/CLAUDE.md).
